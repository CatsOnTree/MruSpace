...
import PpPrmCom from "./PpPrmCom";

export default function PpContent({ppactiveComponent}) {
  const contentObj = {
    largenum: {
...
Tuple Elements :  (10, 20, 30)`,
  ...
  return <div>
    {ppactiveComponent === "ComponentA" && <PpPrmCom propsContent={contentObj.sumofnum}/>}
    {ppactiveComponent === "ComponentB" && <PpPrmCom propsContent={contentObj.simplecalc}/>}
    {ppactiveComponent === "ComponentC" && <PpPrmCom propsContent={contentObj.relationoper}/>}
    {ppactiveComponent === "ComponentD" && <PpPrmCom propsContent={contentObj.logicoper}/>}
    {ppactiveComponent === "ComponentE" && <PpPrmCom propsContent={contentObj.swapping}/>}
    {ppactiveComponent === "ComponentF" && <PpPrmCom propsContent={contentObj.simpleint}/>}
    {ppactiveComponent === "ComponentG" && <PpPrmCom propsContent={contentObj.largenum}/>}
    {ppactiveComponent === "ComponentH" && <PpPrmCom propsContent={contentObj.listwo}/>}
    {ppactiveComponent === "ComponentI" && <PpPrmCom propsContent={contentObj.tuple}/>}
  </div>;
}
